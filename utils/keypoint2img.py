...
def read_keypoints(json_input, size, random_drop_prob=0, remove_face_labels=False, basic_point_only=False, People_List=[0, 1, 2, 3, 4, 5, 6]):
    ...
    for i in People_List:
        with io.open(json_input.replace('dancer0', 'dancer{}'.format(str(i))), encoding='utf-8') as f:
